				...
				<div className="row">
					<div className="card text-dark bg-light mb-3">
						<div className="card-header">
							<h3> <b>Politicas de Privacidad y Tratamiento de Datos</b> </h3>
						</div>
						<div className="card-body">
							<ol>
								<li><strong>Definiciones</strong></li>
							</ol>
							<p>Para facilitar la comprensión de estas Condiciones de Uso del Sitio Web, se hace necesario aclarar el significado de las siguientes palabras: <br />
							...
							<p>Se presume que cuando un usuario accede al sitio Web lo hace bajo su total responsabilidad y que, por tanto, acepta plenamente y sin reservas el contenido de los términos y condiciones de uso del sitio Web. MINTIC se reserva, en todos los sentidos, el derecho de actualizar y modificar en cualquier momento y de cualquier forma, de manera unilateral y sin previo aviso, las presentes condiciones de uso, políticas de privacidad y los contenidos de la página. <br /></p>
							<ol start="3">
								<li><b>Contenidos del Sitio Web</b></li>
							</ol>
							...
							<b>3.1. Responsabilidad por la información contenida</b>
							...
							<p>La propiedad intelectual sobre los contenidos del Sitio Web o bien hacen parte del patrimonio de MINTIC o, en su caso, su titularidad es de terceros que autorizaron el uso de los mismos en el Sitio Web o es información pública que se rige por las leyes de acceso a la información pública colombianas.<br />
							...
							<ol start="7">
								<li><b>Participación dentro del Sitio Web</b></li>
							</ol>
